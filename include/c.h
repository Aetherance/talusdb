...
uint8_t leveldb_iter_valid(const leveldb_iterator_t*);
...
void leveldb_writebatch_put(leveldb_writebatch_t*, const char* key, size_t klen, const char* val,
                            size_t vlen);
void leveldb_writebatch_delete(leveldb_writebatch_t*, const char* key, size_t klen);
void leveldb_writebatch_iterate(const leveldb_writebatch_t*, void* state,
...
enum { leveldb_no_compression = 0, leveldb_snappy_compression = 1, leveldb_zstd_compression = 2 };
